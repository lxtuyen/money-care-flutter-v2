...
class GetGoalPredictionsUseCase {
  final SavingGoalRepository repository;

  GetGoalPredictionsUseCase(this.repository);

  Future<Either<Failure, GoalAchievementPredictionSummaryModel>> call() {
    return repository.getGoalPredictions();
  }
}
