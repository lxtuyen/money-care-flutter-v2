...
@JsonKey(name: 'startDate') String? get startDate;@JsonKey(name: 'endDate') String? get endDate; String? get type;
...
bool operator ==(Object other) {
  return identical(this, other) || (other.runtimeType == runtimeType&&other is TransactionTotalsDto&&(identical(other.startDate, startDate) || other.startDate == startDate)&&(identical(other.endDate, endDate) || other.endDate == endDate)&&(identical(other.type, type) || other.type == type));
}
...
@override
String toString() {
  return 'TransactionTotalsDto(startDate: $startDate, endDate: $endDate, type: $type)';
}
...
@useResult
$Res call({
@JsonKey(name: 'startDate') String? startDate,@JsonKey(name: 'endDate') String? endDate, String? type
});
...
/// Create a copy of TransactionTotalsDto
/// with the given fields replaced by the non-null parameter values.
@pragma('vm:prefer-inline') @override $Res call({Object? startDate = freezed,Object? endDate = freezed,Object? type = freezed,}) {
...
@optionalTypeArgs TResult maybeWhen<TResult extends Object?>(TResult Function(@JsonKey(name: 'startDate')  String? startDate, @JsonKey(name: 'endDate')  String? endDate,  String? type)?  $default,{required TResult orElse(),}) {final _that = this;
switch (_that) {
case _TransactionTotalsDto() when $default != null:
...
@optionalTypeArgs TResult when<TResult extends Object?>(TResult Function(@JsonKey(name: 'startDate')  String? startDate, @JsonKey(name: 'endDate')  String? endDate,  String? type)  $default,) {final _that = this;
switch (_that) {
case _TransactionTotalsDto():
return $default(_that.startDate,_that.endDate,_that.type);case _:
  throw StateError('Unexpected subclass');
...
@optionalTypeArgs TResult? whenOrNull<TResult extends Object?>(TResult? Function(@JsonKey(name: 'startDate')  String? startDate, @JsonKey(name: 'endDate')  String? endDate,  String? type)?  $default,) {final _that = this;
switch (_that) {
case _TransactionTotalsDto() when $default != null:
return $default(_that.startDate,_that.endDate,_that.type);case _:
  return null;
...
class _TransactionTotalsDto implements TransactionTotalsDto {
  const _TransactionTotalsDto({@JsonKey(name: 'startDate') this.startDate, @JsonKey(name: 'endDate') this.endDate, this.type});
...
@override
bool operator ==(Object other) {
  return identical(this, other) || (other.runtimeType == runtimeType&&other is _TransactionTotalsDto&&(identical(other.startDate, startDate) || other.startDate == startDate)&&(identical(other.endDate, endDate) || other.endDate == endDate)&&(identical(other.type, type) || other.type == type));
}
...
/// Create a copy of TransactionTotalsDto
/// with the given fields replaced by the non-null parameter values.
@override @pragma('vm:prefer-inline') $Res call({Object? startDate = freezed,Object? endDate = freezed,Object? type = freezed,}) {
