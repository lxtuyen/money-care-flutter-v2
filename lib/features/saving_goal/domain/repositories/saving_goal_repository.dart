...
abstract class SavingGoalRepository {
  ...
  Future<Either<Failure, List<SavingGoalEntity>>> getSavingGoalsByUser(int userId);
  ...
  Future<Either<Failure, SavingGoalEntity?>> selectSavingGoal(int userId, int id);
  Future<Either<Failure, ExpiredGoalCheckModel>> checkExpiredSavingGoal(int userId);
  Future<Either<Failure, bool>> markAsNotified(int id);
  Future<Either<Failure, SavingGoalEntity>> extendSavingGoal(int id, DateTime newEndDate, {DateTime? newStartDate});
