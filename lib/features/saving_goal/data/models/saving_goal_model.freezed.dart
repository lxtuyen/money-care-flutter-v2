...
@JsonKey(includeFromJson: false, includeToJson: false)
@override
int get hashCode => Object.hash(runtimeType,id,name,isSelected,const DeepCollectionEquality().hash(categories),target,savedAmount,isCompleted,templateKey,startDate,endDate,updatedAt,status,wallet);

@override
String toString() {
  return 'SavingGoalModel(id: $id, name: $name, isSelected: $isSelected, categories: $categories, target: $target, savedAmount: $savedAmount, isCompleted: $isCompleted, templateKey: $templateKey, startDate: $startDate, endDate: $endDate, updatedAt: $updatedAt, status: $status, wallet: $wallet)';
}
...
switch (_that) {
case _SavingGoalModel() when $default != null:
return $default(_that.id,_that.name,_that.isSelected,_that.categories,_that.target,_that.savedAmount,_that.isCompleted,_that.templateKey,_that.startDate,_that.endDate,_that.updatedAt,_that.status,_that.wallet);case _:
  return orElse();
...
@JsonKey(includeFromJson: false, includeToJson: false)
@override
int get hashCode => Object.hash(runtimeType,id,name,isSelected,const DeepCollectionEquality().hash(_categories),target,savedAmount,isCompleted,templateKey,startDate,endDate,updatedAt,status,wallet);
