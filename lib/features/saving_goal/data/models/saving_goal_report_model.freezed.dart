...
@JsonKey(fromJson: NumParser.parseInt) int get id; String get name;@JsonKey(name: 'start_date') DateTime? get startDate;@JsonKey(name: 'end_date') DateTime? get endDate;@JsonKey(fromJson: NumParser.parseDouble) double get target;@JsonKey(name: 'current_balance', fromJson: NumParser.parseDouble) double get currentBalance;@JsonKey(name: 'progress_percent', fromJson: NumParser.parseInt) int get progressPercent;@JsonKey(name: 'is_completed') bool get isCompleted; List<MilestoneModel> get milestones; int get balanceUsagePercentage; double get totalSpent; bool get isOverBudget; int get targetCompletionPercentage; bool get isTargetAchieved; List<CategorySpendingModel> get categoryBreakdown; int get totalTransactions; double get dailyAverageSpending; double get remainingBudget;
