...
class SavingFundReportModel {
  ...
  final int budgetUsagePercentage;
  ...
  factory SavingFundReportModel.fromMap(Map<String, dynamic> json) {
    return SavingFundReportModel(
      fundId: json['fund_id'],
      ...
      totalSpent: double.tryParse(json['total_spent'].toString()) ?? 0,
      remainingBudget: double.tryParse(json['remaining_budget'].toString()) ?? 0,
      budgetUsagePercentage: json['budget_usage_percentage'] ?? 0,
