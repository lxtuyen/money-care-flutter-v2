...
import 'package:money_care/features/saving_fund/data/models/saving_fund_report_model.dart';
import 'package:money_care/features/saving_fund/presentation/controllers/saving_fund_controller.dart';

class SavingFundReportScreen extends StatefulWidget {
  const SavingFundReportScreen({super.key});

  @override
  State<SavingFundReportScreen> createState() => _SavingFundReportScreenState();
}

class _SavingFundReportScreenState extends State<SavingFundReportScreen> {
  ...
  Widget _buildHeaderCard(SavingFundReportModel report) {
    return Container(
  ...
  Widget _buildProgressCircle(SavingFundReportModel report) {
  ...
  Widget _buildBudgetCard(SavingFundReportModel report) {
    return _Card(
      title: 'Ngân sách',
      child: Column(
        children: [
          _InfoRow(
            label: 'Ngân sách',
            value: currencyFormatter.format(report.budget),
          ),
          const SizedBox(height: 8),
          _InfoRow(
            label: 'Đã chi tiêu',
            ...
            children: [
              ...
              ClipRRect(
                ...
                child: LinearProgressIndicator(
                  value: (report.budgetUsagePercentage / 100).clamp(0.0, 1.0),
                  minHeight: 8,
  ...
  Widget _buildStatsCard(SavingFundReportModel report) {
    return _Card(
      title: 'Thống kê',
      child: Row(
        children: [
  ...
  Widget _buildCategoryBreakdown(SavingFundReportModel report) {
    return _Card(
  ...
  Widget _buildTimeCard(SavingFundReportModel report) {
    return _Card(
      title: 'Thời gian',
      child: Row(
        children: [
