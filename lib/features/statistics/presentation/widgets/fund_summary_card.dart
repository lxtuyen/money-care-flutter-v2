...
class FundSummaryCard extends StatelessWidget {
          ...
          Container(
            ...
            child: Row(
              children: [
                ...
                GestureDetector(
                  onTap: () => Get.toNamed(RoutePath.fundReport, arguments: fund.id),
                  child: Container(
  ...
  Widget _buildFromFundOnly() {
    return Padding(
      ...
      child: Column(
        children: [
          if (fund.balance != null && fund.balance! > 0)
            _BudgetRow(
              label: 'Ngân sách',
              value: AppHelperFunction.formatAmount(fund.balance!, 'VND'),
              progress: 0,
  ...
  Widget _buildFromReport(FundReportModel r) {
    return Padding(
      padding: const EdgeInsets.all(16),
      child: Column(
        crossAxisAlignment: CrossAxisAlignment.start,
